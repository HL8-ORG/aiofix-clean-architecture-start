...
describe('PinoLoggerService', () => {
  ...
  describe('specialized logging', () => {
    it('should log performance messages', () => {
      const spy = jest.spyOn(service as any, 'log');
      service.performance('database_query', 150, LogContext.DATABASE, { table: 'users' });
    ...
    it('should log business messages', () => {
      const spy = jest.spyOn(service as any, 'log');
      service.business('User registered', { userId: '123', email: 'test@example.com' });
    ...
    it('should log security messages', () => {
      const spy = jest.spyOn(service as any, 'log');
      service.security('Failed login attempt', { ip: '192.168.1.1', username: 'test' });
  ...
  describe('configuration', () => {
    ...
    it('should get and update config', () => {
      ...
      expect(configService.updateConfig).toHaveBeenCalledWith({ level: 'warn' });
  ...
  describe('child logger', () => {
    it('should create child logger', () => {
      ...
      const childLogger = service.child(LogContext.DATABASE, { tenantId: '123' });
